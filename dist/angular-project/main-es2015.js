...
let HomepageServicesComponent = class HomepageServicesComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let StartBoxComponent = class StartBoxComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let WritersComponent = class WritersComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let AcademicServicesComponent = class AcademicServicesComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let SoftwareServicesComponent = class SoftwareServicesComponent {
    constructor() { }
    ngOnInit() {
    }
};
